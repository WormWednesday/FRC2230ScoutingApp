...
class _ScoutingScreenState extends State<ScoutingScreen > {
  ...
  final TextEditingController _robotCommentsController = TextEditingController();
  ...
  void initState() {
    ...
    _matchNumberController.addListener(() {
     ...
     _climbBeforeEndSecsController.addListener(() {
      ...
      _climbBeforeEndSecsController.value = _climbBeforeEndSecsController.value.copyWith(
    ...
    _strategyController.addListener(() {
     ...
     _shootingPrepTimeController.addListener(() {
      ...
      _shootingPrepTimeController.value = _shootingPrepTimeController.value.copyWith(
                      ...
                      children: [
                        Container(
                          ...
                          child: Padding(
                            ...
                            validator: (String? value) => (value == null) ? 'Must select position sending data' : null
                            )
                            ),
                        ),
                        const SizedBox(
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: DropdownButtonFormField(
                          ...
                          hint: const Text('Where did robot gather most balls?'),
